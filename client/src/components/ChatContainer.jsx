...
const ChatContainer = () => {
 ...
 const handleSendMessage = async (e) => {
  e.preventDefault();
  if (!selectedUser) return; // Prevent sends if no chat selected
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col  h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messages
  .filter((msg) => msg && typeof msg === "object" && msg.senderId)  // filter out undefined/null/bad messages
  .map((msg, index) => (
